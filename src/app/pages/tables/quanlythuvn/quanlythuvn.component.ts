...
@Component({
  selector: 'ngx-quanlythuvn',
  templateUrl: './quanlythuvn.component.html',
  styleUrls: ['./quanlythuvn.component.scss']
})
export class QuanlythuvnComponent implements OnInit {
  ...
  constructor(private service: NetworkserviceService) {
    ...
    this.service.getquanlythuvndanhsachdonhang().subscribe(val => {
      console.log(val)
      val.forEach(element => {
        this.totalmoney += Number(element.sotien)
        if (element.mucdich.includes('dh')) {

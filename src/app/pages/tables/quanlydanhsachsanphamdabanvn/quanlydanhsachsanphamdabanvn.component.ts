...
@Component({
  ...
  templateUrl: './quanlydanhsachsanphamdabanvn.component.html',
  styleUrls: ['./quanlydanhsachsanphamdabanvn.component.scss']
})
export class QuanlydanhsachsanphamdabanvnComponent implements OnInit {

...
@Component({
  selector: 'ngx-quanlydanhsachsanphamdabannhat',
  templateUrl: './quanlydanhsachsanphamdabannhat.component.html',
  styleUrls: ['./quanlydanhsachsanphamdabannhat.component.scss']
})
export class QuanlydanhsachsanphamdabannhatComponent implements OnInit {

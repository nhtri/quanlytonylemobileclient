...
//   console.log('test',this.router.getCurrentNavigation().extras.state.sodienthoai)
...
export class DanhsachsanphamkhachhangdamuaComponent implements OnInit {
  ...
  constructor(private service: NetworkserviceService, private router: Router) {
    ...
    this.service.danhsachsanphamdabankhachhang([this.router.getCurrentNavigation().extras.state.ten]).subscribe(value => {
      this.data = value

                                        ...
                                        this.service.deletequanlythutransactionkey([this.transactionkey]).subscribe(c => {
                                            ...
                                            if (i == this.datas.length - 1) {
                                                ...
                                                this.service.taodanhsachdonhang([
                                                    ...
                                                    this.vitri, this.hinhthucthanhtoan, this.tongtienban,
                                                    this.tienmat, this.daikibi,
                                                    this.chuyenkhoan, this.hinhthucthanhtoan, this.thongtinkhachhang,
                                                ]).subscribe(value => {

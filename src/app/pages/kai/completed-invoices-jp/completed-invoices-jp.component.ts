...
@Component({
    selector: 'ngx-completed-invoices-jp',
    templateUrl: './completed-invoices-jp.component.html',
    styleUrls: ['./completed-invoices-jp.component.scss'],
})
export class CompletedInvoicesJpComponent implements OnInit {
    ...
    getOrdersCompleted() {
        this.kaiService.getShopJPCompletedInvoices().subscribe(completedForSaleInvoices => {

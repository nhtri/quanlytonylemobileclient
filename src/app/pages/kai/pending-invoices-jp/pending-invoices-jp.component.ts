...
@Component({
    selector: 'ngx-pending-invoices-jp',
    templateUrl: './pending-invoices-jp.component.html',
    styleUrls: ['./pending-invoices-jp.component.scss'],
})
export class PendingInvoicesJpComponent implements OnInit {
    ...
    getOrdersPending() {
        this.kaiService.getShopJpPendingInvoices().subscribe(pendingForSaleInvoices => {
        ...
        if (notEmpty(rowData)) {
            ...
            switch (rowData.type) {
                case INVOICE_TYPE.TRANSFERRING:
                    this.kaiService.getShopJPTransferringInvoiceDetail(rowData.invoice_id).subscribe((orderDetail) => {
                ...
                default:
                    this.kaiService.getShopJPForSaleInvoiceDetail(rowData.invoice_id).subscribe((orderDetail) => {

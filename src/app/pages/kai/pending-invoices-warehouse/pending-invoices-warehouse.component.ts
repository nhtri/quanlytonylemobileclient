...
@Component({
    selector: 'ngx-pending-invoices-warehouse',
    templateUrl: './pending-invoices-warehouse.component.html',
    styleUrls: ['./pending-invoices-warehouse.component.scss'],
})
export class PendingInvoicesWarehouseComponent implements OnInit {
    ...
    getOrdersPending() {
        this.kaiService.getWarehousePendingInvoices().subscribe(pendingForSaleInvoices => {
        ...
        if (notEmpty(rowData)) {
            ...
            switch (rowData.type) {
                case INVOICE_TYPE.TRANSFERRING:
                    this.kaiService.getWarehouseTransferringInvoiceDetail(rowData.invoice_id)
                ...
                default:
                    this.kaiService.getWarehouseForSaleInvoiceDetail(rowData.invoice_id).subscribe((orderDetail) => {

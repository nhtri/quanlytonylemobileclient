...
@Component({
    selector: 'ngx-completed-invoices-warehouse',
    templateUrl: './completed-invoices-warehouse.component.html',
    styleUrls: ['./completed-invoices-warehouse.component.scss'],
})
export class CompletedInvoicesWarehouseComponent implements OnInit {
    ...
    getOrdersCompleted() {
        this.kaiService.getWarehouseCompletedInvoices().subscribe(completedForSaleInvoices => {

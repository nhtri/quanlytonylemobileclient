...
import { QuanlytonychartjsComponent } from './quanlytonychartjs/quanlytonychartjs/quanlytonychartjs.component';
...
@NgModule({
  ...
  declarations: [...routedComponents, ...components, QuanlytonychartjsComponent],
})
